...
> Dezentrale Compute-Schicht fuer AI-Workloads und Engine-Berechnungen.
...
```
atc-compute (dezentrale Compute-Schicht)
    +-- jobs/ - scheduler/
    +-- verification/ (Ergebnis-Attestation)
    +-- Integration: aurora-ai (Model-Ausfuehrung) - genesis-engine
```
...
- **Purpose:** Compute-Service (L5, Roadmap M6).
- **Scope:** Layer L5, Domain compute — atc-compute als CORE in der 23-Repo-Landschaft (AD-024/026).
- **Architecture:** Kernel-Fundament (Service-Space, AD-028).
